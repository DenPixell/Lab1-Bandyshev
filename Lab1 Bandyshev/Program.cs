...
class Program
{
    static void Main(string[] args)
    {
        ...
        var date2 = new DateTime(2002, 05, 21);
        var date3 = new DateTime(2002, 04, 19);
        ...
        student.Exam = new Exam[] { new Exam("geography", 4, date3) };
        student.Group = 15;

        student.AddExams(new Exam("history", 4, date1), new Exam("chemistry", 5, date2));

        student2.AddExams(new Exam("match", 5, date1), new Exam("chemistry", 5, date3));
